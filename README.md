...
Client records are administered by OWNER/ADMIN roles and contain contact and outcome configuration. Supplier records contain contacts, STATIC/DYNAMIC redirect mode, outcome destinations, and opaque Test/Live links. Live links enforce project/supplier state, assignment quota, event ingestion, duplicate/fraud controls, masked client callbacks, and security termination before sending a respondent to the configured project survey URL.
