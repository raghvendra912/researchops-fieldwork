...
const demo = {
  portfolio: { starts: 5377, reached: 4920, completes: 1994, terminates: 2028, overQuota: 516, qualityTerminates: 224, abandons: 387, inProgress: 228, conversionRate: 37.1, dropOffRate: 7.2, lastEventAt: new Date().toISOString() },
