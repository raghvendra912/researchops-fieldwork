...
export type NormalizedEvent = { organizationId: string; projectCode: string; supplierId?: string; respondentRef: string; eventType: string; providerTransactionId?: string; occurredAt?: string; isTest?: boolean; metadata?: Record<string, unknown> };
