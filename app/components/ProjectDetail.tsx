...
export function ProjectDetail({ projectId }: { projectId: string }) {
  ...
  return <>
    ...
    </section></div><ProjectMarketsEditor projectId={project.id} configured={configured} token={token} canOperate={canOperate} /><ProjectEligibilityEditor projectId={project.id} configured={configured} token={token} canOperate={canOperate} />
  </>;
}
