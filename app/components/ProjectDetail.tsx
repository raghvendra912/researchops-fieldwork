...
export function ProjectDetail({ projectId }: { projectId: string }) {
  ...
  return <>
    ...
    </section></div><ProjectMarketsEditor projectId={project.id} configured={configured} token={token} canOperate={canOperate} /><ProjectSurveySetupEditor projectId={project.id} configured={configured} token={token} canOperate={canOperate} /><ProjectResponseVariablesEditor projectId={project.id} configured={configured} token={token} canOperate={canOperate} /><ProjectEligibilityEditor projectId={project.id} configured={configured} token={token} canOperate={canOperate} /><ProjectQuotaCellsEditor projectId={project.id} configured={configured} token={token} canOperate={canOperate} /><ProjectAccessEditor projectId={project.id} configured={configured} token={token} />
  </>;
}
